...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Sachovnica", 500, 500, 
                                         Color.white);
        }
    ...
    private class CanvasPane extends JPanel {
        public void paint(Graphics graphic) {
            ...
            for(int i = 1; i < 9; i++) {
               graphic.drawString(String.valueOf(i), 25 + (50 * (i - 1)), 420);
               graphic.drawString(String.valueOf(i), 420, 25 + (50 * (i - 1)));
            }
        }
    }
